...
class App extends Component {
    ...
    handleSubmit = (item) => {
        ...
        axios
            .post("/api/todos/", item)
            .then((res) => this.refreshList());
        // alert("save your face" + JSON.stringify(item)); // message to the browser?
    }; 
    ...
    renderTabList = () => { // currently not showing tabs
        return (
    ...
    render() {
        return (
            <main className = "container">
                ...
                {this.state.modal ? (
                    <Modal 
                        activeItem = {this.state.activeItem} // represents the todo being edited
                        toggle = {this.toggle} // a function used to control the modal's state (open/close)
                        onSave = {this.handleSubmit} // a function that saves the edited values for the todo item
                    />
                ): null}
            </main>
        )
...
//         <p>
//           Edit <code>src/App.js</code> and save to reload. Where are the bananas?
//         </p>
//         <a
//           className="App-link"
